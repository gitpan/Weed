...
isa_ok tied $weed->getValue->getTiedField('metadata'),    'Weed::Tie::Field';
isa_ok tied $weed->getValue->getTiedField('family'),      'Weed::Tie::Field';
isa_ok tied $weed->getValue->getTiedField('horizontal'),  'Weed::Tie::Field';
isa_ok tied $weed->getValue->getTiedField('justify'),     'Weed::Tie::Field';
isa_ok tied $weed->getValue->getTiedField('string'),      'Weed::Tie::Field';
isa_ok tied $weed->getValue->getTiedField('language'),    'Weed::Tie::Field';
isa_ok tied $weed->getValue->getTiedField('leftToRight'), 'Weed::Tie::Field';
isa_ok tied $weed->getValue->getTiedField('size'),        'Weed::Tie::Field';
isa_ok tied $weed->getValue->getTiedField('spacing'),     'Weed::Tie::Field';
isa_ok tied $weed->getValue->getTiedField('style'),       'Weed::Tie::Field';
isa_ok tied $weed->getValue->getTiedField('topToBottom'), 'Weed::Tie::Field';

ok tied $weed->getValue->getTiedField('metadata');
ok tied $weed->getValue->getTiedField('family');
ok tied $weed->getValue->getTiedField('horizontal');
ok tied $weed->getValue->getTiedField('justify');
ok tied $weed->getValue->getTiedField('string');
ok tied $weed->getValue->getTiedField('language');
ok tied $weed->getValue->getTiedField('leftToRight');
ok tied $weed->getValue->getTiedField('size');
ok tied $weed->getValue->getTiedField('spacing');
ok tied $weed->getValue->getTiedField('style');
ok tied $weed->getValue->getTiedField('topToBottom');
